...
dependencies {
  ...
  runtimeOnly("com.diffplug.spotless:spotless-plugin-gradle:6.18.0")                                       // Enable a code formatting plugin
  ...
  runtimeOnly("org.ajoberstar.grgit:grgit-gradle:5.0.0")                                                   // Enable website git publish to asf-site branch
  ...
  runtimeOnly("org.checkerframework:checkerframework-gradle-plugin:0.6.26")                                 // Enable enhanced static checking plugin
}
